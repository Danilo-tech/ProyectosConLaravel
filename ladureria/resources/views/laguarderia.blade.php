...
@section('pageTitle', 'La Guarderia')
@section('cuerpo')
        ...
        <div class="parallax-content section-34 section-md-66 text-lg-left context-dark bg-overlay-info">
            <div class="container">
                <div class="d-none d-md-block d-lg-inline-block">
                    <h1 class="font-weight-bold"><span class="big">La guardería</span></h1></div>
                <div class="pull-lg-right offset-md-top-10 offset-lg-top-41">
                    <ul class="p list-inline list-inline-dashed">
                        ...
                        <li class="list-inline-item">La guardería</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="section novi-background section-98 section-lg-124">
        <div class="container">
            <h1 class="text-primary font-weight-bold">Propuesta de educación temprana</h1>
            ...
            <div class="row justify-content-sm-center">
                <div class="col-sm-10 col-md-8">
                    <p class="">Atención a peques de 3 meses a 2 años con horario ampliado de atención, según las necesidades de padres y madres.&nbsp;Inspirado en el enfoque Reggio Emilia: la pedagogía del asombro; donde se aprender a partir de la experimentación y el ambiente juega un rol fundamental. Espacios estimulantes y seguros, con sistema de video vigilancia.
                        <br>
                        <br>Horario: <span data-novi-id="25">De lunes a viernes</span> de 7 am a 8 pm y <span data-novi-id="26">opcional sábados</span> por la mañana. </p>
                </div>
            </div>
            <div class="row justify-content-sm-center offset-top-66">
                <div class="col-sm-10 col-md-6 col-lg-3">
                    <figure class="thumbnail-terry">
                        <a href="#"><img width="270" height="360" src="/images/home-03-270x360.jpg" alt=""></a>
                        <figcaption>
                            <div>
                                <h4 class="thumbnail-terry-title"><span data-novi-id="38">Gateadores</span></h4></div>
                            <p class="thumbnail-terry-desc offset-top-0"></p><a class="btn offset-top-10 offset-md-top-0 btn-safety-orange" href="/gateadores">MÁS INFORMACIÓN</a></figcaption>
                    </figure>
                </div>
                <div class="col-sm-10 col-md-6 col-lg-3 offset-top-50 offset-md-top-0">
                    <figure class="thumbnail-terry">
                        <a href="#"><img width="270" height="360" src="/images/home-04-270x360.jpg" alt=""></a>
                        <figcaption>
                            <div>
                                <h4 class="thumbnail-terry-title"><span data-novi-id="32">Caminantes</span></h4></div>
                            <p class="thumbnail-terry-desc offset-top-0"></p><a class="btn offset-top-10 offset-md-top-0 btn-safety-orange" href="/caminantes">Más información</a></figcaption>
                    </figure>
                </div>
                <div class="col-sm-10 col-md-6 col-lg-3 offset-top-50 offset-lg-top-0">
                    <figure class="thumbnail-terry">
                        <a href="#"><img width="270" height="360" src="/images/home-05-270x360.jpg" alt=""></a>
                        <figcaption>
                            <div>
                                <h4 class="thumbnail-terry-title"><span data-novi-id="29">Toddlers</span></h4></div>
                            <p class="thumbnail-terry-desc offset-top-0"></p><a class="btn offset-top-10 offset-md-top-0 btn-safety-orange" href="/toddlers">MÁS INFORMACIÓN</a></figcaption>
                    </figure>
                </div>
                <div class="col-sm-10 col-md-6 col-lg-3 offset-top-50 offset-lg-top-0">
                    <figure class="thumbnail-terry">
                        <a href="#"><img width="270" height="360" src="/images/home-06-270x360.jpg" alt=""></a>
                        <figcaption>
                            <div>
                                <h4 class="thumbnail-terry-title"><span data-novi-id="28">Pre escolares</span></h4></div>
                            <p class="thumbnail-terry-desc offset-top-0"></p><a class="btn offset-top-10 offset-md-top-0 btn-safety-orange" href="/pre-escolares">MÁS INFORMACIÓN</a></figcaption>
                    </figure>
                </div>
            </div>
        </div>
    ...
    <div class="parallax-container section" data-parallax-img="/images/bg-02-1920x748.jpg">
        <div class="parallax-content section-66 context-dark">
            <div class="container">
                <h1 class="font-weight-bold">¿Tienes sugerencias?</h1>
                <div class="row justify-content-sm-center offset-top-20">
                    <div class="col-sm-10 col-sm-8">
                        <div>
                            <p>Estaremos felices de escuchar tú opiniones y sugerencias, escrìbenos :)</p>
                        </div>
                        <div class="offset-top-30"><a class="btn btn-icon btn-icon-left btn-default" href="/contacto"><span class="novi-icon icon mdi-email-outline mdi"></span><span>Envíanos tus ideas</span></a></div>
                    </div>
                </div>
            </div>
        </div>
